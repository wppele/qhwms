...
class ArrearsSettlePage(ttk.Frame):
    ...
    def create_widgets(self):
        columns = ("debt_id", "outbound_id", "item_ids", "remaining_debt")
        self.tree = ttk.Treeview(self, columns=columns, show="headings")
        self.tree.heading("debt_id", text="欠账ID")
        self.tree.heading("outbound_id", text="出库单ID")
        self.tree.heading("item_ids", text="明细ID")
    ...
    def refresh(self):
        ...
        for debt in debts:
            self.tree.insert('', tk.END, values=debt)
    ...
    def settle_selected(self):
        ...
        debt_id, outbound_id, item_ids, remaining_debt = item['values']
